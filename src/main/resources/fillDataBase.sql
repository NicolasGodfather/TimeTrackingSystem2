...
insert into time.employee (firstName, lastName, position) value( 'Anna', 'Rosolko', 'designer' );
insert into time.employee (firstName, lastName, position) value( 'Arkadiy', 'Kuznetsov', 'developer' );
